...
Production-ready Rate Limiter X service with REST API, **five-algorithm support** (Token Bucket, Sliding Window, Fixed Window, Leaky Bucket, Composite), Redis backend, comprehensive monitoring, and 265+ tests.
...
- **Production JAR**: `java -jar target/rate-limiter-x-1.1.0.jar`
