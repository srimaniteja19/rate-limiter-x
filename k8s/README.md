...
This directory contains comprehensive production-ready deployment infrastructure for the Rate Limiter X service.
...
1. **Image Pull Errors**
   ...
   docker pull ghcr.io/srimaniteja19/rate-limiter-x:latest
...
kubectl set image deployment/rate-limiter rate-limiter=ghcr.io/srimaniteja19/rate-limiter-x:v1.2.3 -n rate-limiter
