...
<img src="drl-logo.png" alt="Rate Limiter X Logo" width="200" height="200">
...
[![Build Status](https://github.com/srimaniteja19/rate-limiter-x/workflows/CI%2FCD%20Pipeline/badge.svg)](https://github.com/srimaniteja19/rate-limiter-x/actions)
...
A modern, real-time React-based dashboard for monitoring and managing your Rate Limiter X.
...
wget https://github.com/srimaniteja19/rate-limiter-x/releases/download/v1.0.0/rate-limiter-x-1.0.0.jar

# Verify checksum (optional)
wget https://github.com/srimaniteja19/rate-limiter-x/releases/download/v1.0.0/rate-limiter-x-1.0.0.jar.sha256
sha256sum -c rate-limiter-x-1.0.0.jar.sha256
```
...
wget https://github.com/srimaniteja19/rate-limiter-x/releases/download/v1.0.0/docker-compose.yml
docker-compose up -d
...
cd rate-limiter-x
./mvnw clean install
java -jar target/rate-limiter-x-1.0.0.jar
```
...
- **Issues**: Report bugs and request features via [GitHub Issues](https://github.com/srimaniteja19/rate-limiter-x/issues)
